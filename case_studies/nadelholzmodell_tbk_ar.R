############################################################################
# Predict forest type (coniferous/deciduous/non-forest) using multi-temporal sentinel-2 data and 
...
setwd("/mnt/cephfs/data/HAFL/WWI-Sentinel-2/Data/TBk_AR/")
...
STACK_DATES = c("20170311", "20170407", "20170626", "20170825")

# path for training data shapefile
SP.PATH = "training_data.shp"
...
stk = stack(c(rf.prediction.prob1,rf.prediction.prob2,rf.prediction.prob3))
